...
<div class="row" style='margin:10px 40px 40px 40px'>
      <div class="col-md-12">
        <form class="form-horizontal" id="formcomida" name="formcomida" action="{{route('proveedor_producto.store')}}" method="POST">
          @csrf
          <div class="panel panel-warning">
            <div class="panel-heading" style='padding-top:20px'>
              <h3 class="panel-title"><span class="fa  fa-cutlery" ></span><b> Proveedor | Producto</b></h3>
            </div>
            <div class="panel-body">
              ...
              <a href="{{route('proveedor_producto.index')}}" class="btn btn-danger">Cancelar</a>
